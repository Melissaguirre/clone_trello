...
from app.models.workSpaceUsers import  WorkspaceUsers
...
class CRUDWorkspaceUser(CRUDBase[WorkspaceUsers, WorkspaceUserCreate, WorkspaceUserUpdate]):
    ...
    async def create(self, *, obj_in : WorkspaceUserCreate) -> WorkspaceUsers:
        db_obj = await WorkspaceUsers.create(workspaceID = obj_in.workspaceID, userID = obj_in.userID, date = obj_in.date)
        return db_obj
